...
"""
FastAPI application for the Feed Balance Environment.

This module creates an HTTP server that exposes the FeedBalanceEnvironment
...
def main(host: str = "0.0.0.0", port: int = 8000):
    ...
    This function enables running the server without Docker:
        ...
        python -m feed_balance.server.app
    ...
    multiple workers:
        uvicorn feed_balance.server.app:app --workers 4
    """
    import uvicorn
